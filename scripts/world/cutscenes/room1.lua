return {
    ...
    parting = function(cutscene)
        ...
        cutscene:wait(cutscene:walkTo(queen, queen.x + 80, queen.y, 0.25))
        cutscene:wait(0.25)
        ...
        cutscene:wait(0.2)
        cutscene:text("* O-[wait:5]Okay...", "confused_surprise", "noelle")
        cutscene:wait(0.5)
        ...
        cutscene:wait(cutscene:slideTo(queen, 820, queen.y, 0.5))
        queen:remove()
